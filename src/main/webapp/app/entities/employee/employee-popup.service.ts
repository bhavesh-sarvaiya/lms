                ...
                this.employeeService.find(id)
                    .subscribe((employeeResponse: HttpResponse<Employee>) => {
                        ...
                        if (employee.joinDate) {
                            employee.joinDate = {
                                year: employee.joinDate.getFullYear(),
                                month: employee.joinDate.getMonth() + 1,
                                day: employee.joinDate.getDate()
                            };
                        }
                        if (employee.retiredDate) {
                            employee.retiredDate = {
                                year: employee.retiredDate.getFullYear(),
                                month: employee.retiredDate.getMonth() + 1,
                                day: employee.retiredDate.getDate()
                            };
                        }
