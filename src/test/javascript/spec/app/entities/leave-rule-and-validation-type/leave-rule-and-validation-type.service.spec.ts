...
describe('Service Tests', () => {
    ...
    describe('LeaveRuleAndValidationType Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LeaveRuleAndValidationTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/leave-rule-and-validation-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LeaveRuleAndValidationType', () => {
