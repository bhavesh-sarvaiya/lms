...
describe('Service Tests', () => {
    ...
    describe('LeaveRuleAndMaxMinLeave Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LeaveRuleAndMaxMinLeaveService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/leave-rule-and-max-min-leaves';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LeaveRuleAndMaxMinLeave', () => {
