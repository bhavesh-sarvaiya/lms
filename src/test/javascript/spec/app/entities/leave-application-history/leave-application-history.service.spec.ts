...
describe('Service Tests', () => {
    ...
    describe('LeaveApplicationHistory Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LeaveApplicationHistoryService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/leave-application-histories';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return LeaveApplicationHistory', () => {
